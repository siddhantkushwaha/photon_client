...
from modules.audio.fft import getFFT
...
class Stream_Analyzer:
    ...
    def __init__(self,
        ...
        try:
            from modules.audio.stream_reader_pyaudio import Stream_Reader
            ...
            from modules.audio.stream_reader_sounddevice import Stream_Reader
            self.stream_reader = Stream_Reader(
                device=device,
                rate=rate,
                updates_per_second=updates_per_second,
        ...
        if self.visualize:
            from modules.audio.visualizer import Spectrum_Visualizer
