...
from modules.audio.utils import Button
...
class Spectrum_Visualizer:
    ...
    def __init__(self, ear):
        ...
        self.tag_every_n_bins = max(1, round(
            5 * (self.ear.n_frequency_bins / 51)))  # Occasionally display Hz tags on the x-axis
    ...
    def update(self):
        ...
        self.text = self.fps_font.render('Fps: %.1f' % (self.fps), True, (255, 255, 255),
                                         (self.bg_color, self.bg_color, self.bg_color))
